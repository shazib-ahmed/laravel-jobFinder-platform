...
<header>
  <div class="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-bg">
        ...
        <div class="brand-logo">
          <a class="navbar-brand" href="{{ url('/') }}" id="menu-action">
            ...
            <span>{{ config('app.adminName', 'jobFinder Admin Pannel') }}</span>
          </a>
    ...
    <div class="toggle-user-menu" id="toggle-user-menu">
      <ul>
        <li><a href="#">
            <div class="user-photo"><img src="https://dw3i9sxi97owk.cloudfront.net/uploads/thumbs/db9c4e1327eb8fe5e9395a4b04e1ea4a_70x70.jpg" alt=""></div>admin@admin.com
          </a></li>
        <li><a href="">
