        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <ul class="list-unstyled">
              ...
              <?php $__currentLoopData = App\Models\Category::has('jobs')->limit(5)->where('status', 1)->orderBy('name', 'desc')->get();
              $__env->addLoop($__currentLoopData);
              foreach ($__currentLoopData as $cat) : $__env->incrementLoopIndices();
          ...
          <div class="col-md-6">
            ...
            <ul class="list-unstyled">
              <?php $__currentLoopData = App\Models\Category::has('jobs')->limit(5)->where('status', 1)->orderBy('name', 'asc')->get();
              $__env->addLoop($__currentLoopData);
              foreach ($__currentLoopData as $cat) : $__env->incrementLoopIndices();
                $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(route('category.index', [$cat->id, $cat->slug])); ?>"><?php echo e($cat->name); ?> (<?php echo e($cat->jobs->count()); ?>)</a></li>
